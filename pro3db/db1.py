# sqllite: 개인용 db, python에 기본 내장되어있음. 경량 dbms
# 서버를 운영하지 않아 시스템 내에서 별도의 자원을 사용할 필요하가 없다.

import sqlite3

print(sqlite3.sqlite_version)
print()
# conn = sqlite3.connect('exam.db') # db연결 담당. 파일에 데이터가 보관
...
try:
    ...
    # print(cur.fetchone()) # 한개의 행(레코드) 읽기 - record pointer가 있는 지점의 자료만 읽음.
    # print(cur.fetchone()) 
