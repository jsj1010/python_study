# 네트워크 : 두 개 이상의 컴퓨터나 장치를 서로 연결하여 데이터를 주고 받을 수 있도록 구성한 통신환경
...
print(socket.getservbyname('https','tcp')) # 443  80보다 보안
